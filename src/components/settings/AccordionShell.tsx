// src/components/settings/AccordionShell.tsx
// ═══════════════════════════════════════════════════════════════════
//  Shared accordion shell used by every Settings section. Extracted
//  from src/pages/Settings.tsx (Phase 2.1 non-vertical modular pass).
//
//  Visual + behavior unchanged: same controlled mutex card with
//  ResizeObserver-tracked max-height for smooth expansion when the
//  inner content grows (dirty-state Save button appearing, etc.).
// ═══════════════════════════════════════════════════════════════════
