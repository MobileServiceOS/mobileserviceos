    ...
    <>
      ...
      <div className="form-group">
        ...
        <div className="field">
          ...
          <input value={draft.serviceArea} onChange={(e) => change('serviceArea', e.target.value)} placeholder="Broward · Miami-Dade" />
        </div>
      </div>
      <div className="form-group">
  ...
  return (
    <div className="form-group">
      ...
      <div style={{ marginTop: 12, fontSize: 11, color: 'var(--t3)', textAlign: 'center' }}>
        Mobile Service OS v{(import.meta as ImportMeta & { env: Record<string, string> }).env?.npm_package_version || '1.1.0'}
      </div>
    </div>
  );
}
