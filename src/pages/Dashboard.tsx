  ...
  return (
    <div className="page page-enter dashboard-page">
      ...
      <div className="pro-hero card-anim">
        <div className="pro-hero-label">This Week's Gross</div>
      ...
      <div className="quote-box card-anim">
        ...
        <div className="qq-pricing-row">
          <div
            className={'qq-price-tile' + (qqMode === 'suggested' ? ' active' : '')}
            onClick={() => setQqMode('suggested')}
            role="button"
          >
          ...
          <div
            className={'qq-price-tile premium' + (qqMode === 'premium' ? ' active' : '')}
            onClick={() => setQqMode('premium')}
            role="button"
          >
        ...
        <div className="qq-meta">
          Direct cost {money(quote.directCosts)} · target profit {money(quote.targetProfit)}
        </div>
